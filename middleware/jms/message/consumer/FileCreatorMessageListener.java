...
import com.oncore.middleware.fileCreator.table.TriggleFileCreator;
...
//            System.out.print(textMsg.getText());
            ...
            if (isReport) {
                ...
                log.info("creating related trigger for report " + report.getName());
                //create mapping file
...
//                tableCreatorMessageSender.sendMessage(file);
                ...
                tableCreator.createOrUpdateTable(report);
                tableCreator.addTrigger(report);
...
//                //send to queue to create table
//                tableCreatorMessageSender.sendMessage(file);
                tableCreator.createOrUpdateTable(entity);
        ...
        } catch (JMSException | IOException | TemplateException | SQLException e) {
