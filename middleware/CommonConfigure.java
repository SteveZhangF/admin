...
public class  CommonConfigure {
    ...
    @Value("${template_create_schema_file}")
    private String template_create_schema_file;

    @Value("${template_update_schema_file}")
    private String template_update_schema_file;
    ...
    public String getTemplate_update_schema_file() {
        return template_update_schema_file;
    }

    public void setTemplate_update_schema_file(String template_update_schema_file) {
        this.template_update_schema_file = template_update_schema_file;
    }
    ...
    public String getTemplate_create_schema_file() {
        return template_create_schema_file;
    }

    public void setTemplate_create_schema_file(String template_create_schema_file) {
        this.template_create_schema_file = template_create_schema_file;
    }
}
