...
String insert = "insert into newenddtity_1457318495795 (name,userId,deleted) values(:name,:userId,false)";
Map map = new HashMap();
...
String updateSql = "update newenddtity_1457318495795 set  name=:name  where id=:id and userId=:userId";
Map map = new HashMap();
map.put("id",id);
map.put("userId",userId);
map.put("name",params.get("name"));
