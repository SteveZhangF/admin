...
String insert = "insert into newenddtity_1457319015405 (name,userId) values(:name,:userId)";
Map map = new HashMap();
...
String updateSql = "update newenddtity_1457319015405 set  (name) values(:name) where id=:id and userId=:userId";
Map map = new HashMap();
map.put("id",id);
map.put("userId",userId);
map.put("name",params.get("name"));
